...
export function collectAppDom(): AppDom {
  ...
  return {
    ...
    layoutFamilyInput: queryElement(".layout-family-input", HTMLInputElement),
    layoutInstNameInput: queryElement(".layout-inst-name-input", HTMLInputElement),
    ...
    layoutRowMidiSelect: queryElement(".layout-row-midi-select", HTMLSelectElement),
    layoutInsertPositionSelect: queryElement(".layout-insert-position-select", HTMLSelectElement),
    layoutAddRowButton: queryElement(".layout-add-row-button", HTMLButtonElement),
